...
**Relational databases are like spreadsheets of related data. SQL is used to search 'query' the database**
- [x] Why do tables need a `primary key`?
**Fastest way for a database to identify uniquely an item in a database**
